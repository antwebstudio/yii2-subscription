...
use common\modules\subscription\models\SubscriptionUserSearch;
use yii\helpers\ArrayHelper;
/**
 * SubscriptionController implements the CRUD actions for Subscription model.
 */
class SubscribedMemberController extends \ant\subscription\backend\controllers\SubscribedMemberController
{
}
